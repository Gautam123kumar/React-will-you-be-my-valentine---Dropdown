...
function App() {
	...
	return (
		<div id="main">
			...
			<div id="state-title" style={{height:"6rem",width:"50%", border:"black 1px solid", margin:"1rem"}}>
				<div id="state-name">{states[currentState].name}</div>
				<div id="state-description">{states[currentState].description}</div>
			</div>
			<div id="city-title" style={{height:"6rem", width:"50%", border:"black 1px solid", margin:"1rem"}}>
			...
			<div id="landmark-title" style={{height:"6rem",width:"50%", border:"black 1px solid", margin:"1rem"}}>
